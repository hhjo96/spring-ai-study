...
public class BookService {
    ...
    public Book registerBook(BookCreateRequest request) {
        log.info("도서 등록: title={}, author={}", request.title(), request.author());
        ...
        log.info("RDB 저장 완료: id={}", saved.getId());

        // 3) VectorStore 동기화
        vectorStore.add(List.of(toDocument(saved)));
        log.info("VectorStore 동기화 완료: id={}", saved.getId());
